                      ...
                      <table id="dataTable" width="100%" cellspacing="0" class="table" >
                          ...
                          <tbody id="userData">
                                  ...
                                  <tr role ="row" id="<?php echo $user['id_acciones_estrategicas']; ?>">
                                      ...
                                      <td>
                                          <div class="btn-group btn-group-sm w-100 btn-group-h">
                                              <button type="button" class="btn btn-sm btn-info editBtn" style="float: none;"><i class="fas fa-edit"></i></button>
                                              <button type="button" class="btn btn-sm btn-info deleteBtn" style="float: none;"><i class="fas fa-trash"></i></button>                                         
                                              <button type="button" class="btn btn-sm btn-success saveBtn" style="float: none; display: none;">Guardar</button>
                                              <button type="button" class="btn btn-sm btn-danger confirmBtn" style="float: none; display: none;">Confirmar</button>
                                           </div>
                                      </td>
