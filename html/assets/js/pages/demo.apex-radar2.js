...
/*
async function obtenerdato(id,obj){
...
var arrdatosarania = [valrandom(0, 3),valrandom(0, 3),valrandom(0, 3),valrandom(0, 3),valrandom(0, 3),valrandom(0, 3),valrandom(0, 3),valrandom(0, 3)];
...
$('.arania').each(function(i, obj) {
    ...
    var options = {
        series: [{
            name: 'Emprendedor',
            data: [valrandom(0, 3),valrandom(0, 3),valrandom(0, 3),valrandom(0, 3),valrandom(0, 3),valrandom(0, 3),valrandom(0, 3),valrandom(0, 3)],
        }],
        chart: {
            height: '100%',
            type: 'radar',
    ...
    var chartara = new ApexCharts(document.querySelector("#"+obj.getAttribute('id')+""), options);
    chartara.render();
