<link href="<?php echo $completarurl?>assets/css/temp-color.css" rel="stylesheet" type="text/css" />
<link href="<?php echo $completarurl?>assets/fonts/style.css" rel="stylesheet" type="text/css" id="font-icons" />
    ...
    <div class="h-100" id="left-side-menu-container" data-simplebar>
        ...
        <ul class="metismenu side-nav">
            ...
            <li class="side-nav-item">
                <a href="<?php echo $completarurl?>index.php" class="side-nav-link">
                    <i class="icon-ICONO-HOME-GRIS" style="font-size: 1.5em;"></i>
            ...
            <li class="side-nav-item">
                <a href="<?php echo $completarurl?>dashboard/index.php" class="side-nav-link">
                    <i class="fas fa-tachometer-alt" ></i>
                    <span> Tablero</span>
                </a>
            </li>
            <li class="side-nav-item">
                <a href="<?php echo $completarurl?>emprendedor/emprendedores.php" class="side-nav-link">
                    <i class=" icon-ICONO-EMPRENDEDORES-GRIS" style="font-size: 1.5em;"></i>
                    <span> Emprendedores</span>
                </a>
            </li>
            <!--- <li class="side-nav-title side-nav-item">Apps</li>-->
            <li class="side-nav-item">
                <a href="<?php echo $completarurl?>visor/maps-vector.php" class="side-nav-link">
                    <i class="icon-ICONO-VISUALIZADOR-GRIS" style="font-size: 1.5em;"></i>
                    <span> Visor </span>
                </a>
            </li>
            ...
            <li class="side-nav-item">
                ...
                <ul class="side-nav-second-level mm-collapse py-0" aria-expanded="false">
                         
                    
                    
                    <li >
                        <a href="<?php echo $completarurl?>asociaciones/asociaciones.php" >
                            <i class=" mdi mdi-account-group" style="font-size: 1.5em;"></i>
