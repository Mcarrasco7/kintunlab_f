<!DOCTYPE html>
    ...
    <head>
        ...
        <link href="assets/fonts/style.css" rel="stylesheet" type="text/css" id="font-icons" />
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h5 class="text-muted font-weight-normal mt-0" title="Number of Customers">Numero de emprendedores</h5>
                                                <h3 class="mt-3 mb-3">612</h3>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h5 class="text-muted font-weight-normal mt-0" title="Number of Orders">Fondos ganados</h5>
                                                <h3 class="mt-3 mb-3">5,543</h3>
                                                <p class="mb-0 text-muted">
                                                    <span class="text-danger mr-2"><i class="mdi mdi-arrow-down-bold"></i> 1.08%</span>
                                                    <span class="text-nowrap">mas que el año pasado</span>
                                                </p>
                                            </div> <!-- end card-body-->
                                        </div> <!-- end card-->
                                    </div> <!-- end col-->
