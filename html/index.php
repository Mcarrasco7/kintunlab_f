...
<!DOCTYPE html>
    ...
    <style>
            ...
            body {
            animation:bg 1500ms ease-in-out infinite;
            ...
            .carousel-control-prev-icon { background-image:url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' fill='%727cf5' viewBox='0 0 8 8'%3E%3Cpath d='M5.25 0l-4 4 4 4 1.5-1.5-2.5-2.5 2.5-2.5-1.5-1.5z'/%3E%3C/svg%3E"); }
            .carousel-control-next-icon { background-image:url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' fill='%727cf5' viewBox='0 0 8 8'%3E%3Cpath d='M2.75 0l-1.5 1.5L3.75 4l-2.5 2.5L2.75 8l4-4-4-4z'/%3E%3C/svg%3E"); }
    ...
    <body class="loading" data-layout-config='{"leftSideBarTheme":"light","layoutBoxed":false, "leftSidebarCondensed":true, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": false}'  data-leftbar-theme="light" cz-shortcut-listen="true">
        <!-- Begin page -->
                                    ...
                                    <div class="card-body ">
                                        ...
                                        <div id="carouselExampleIndicators2" class="carousel slide" data-ride="carousel">
                                            ...
                                            <div class="carousel-inner">
                                                ...
                                                <div id="test1">
                                                <img data-enlargeable width="100" style="cursor: zoom-in" class="d-block w-100" src="assets/images/infografia/GRAFICOS_INTRO_KINTUNLAB/GRAFICOS_INTRO_KINTUNLAB_page-0001.jpg" alt="First slide">
                                                </div>
                                                </div>
                                                <div class="carousel-item">
                                                <div id="test2">
                                                <img data-enlargeable width="100" style="cursor: zoom-in" class="d-block w-100" src="assets/images/infografia/GRAFICOS_INTRO_KINTUNLAB/GRAFICOS_INTRO_KINTUNLAB_page-0002.jpg" alt="Second slide">
                                                </div>
                                                </div>
                                                <div class="carousel-item">
                                                <div id="test3">
                                                <img data-enlargeable width="100" style="cursor: zoom-in" class="d-block w-100" src="assets/images/infografia/GRAFICOS_INTRO_KINTUNLAB/GRAFICOS_INTRO_KINTUNLAB_page-0003.jpg" alt="Third slide">
                                                </div>
                                                </div>
                                            </div>
                                        ...
                                        <h3 class="text-uppercase my-4 text-center font-weight-normal">Bienvenido(A) a KintunLab</h3>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="carouselExampleIndicators3" class="carousel slide" data-ride="carousel">
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <div id="test4">
                                                        <img data-enlargeable width="100" style="cursor: zoom-in" class="d-block w-100" src="assets/images/infografia/GRAFICOS_USO_PLATAFORMA/GRAFICOS_USO_PLATAFORMA-1.jpg" alt="First slide">
                                                    </div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div id="test5">
                                                        <img data-enlargeable width="100" style="cursor: zoom-in" class="d-block w-100" src="assets/images/infografia/GRAFICOS_USO_PLATAFORMA/GRAFICOS_USO_PLATAFORMA-2.jpg" alt="Second slide">
                                                    </div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div id="test6">
                                                        <img data-enlargeable width="100" style="cursor: zoom-in" class="d-block w-100" src="assets/images/infografia/GRAFICOS_USO_PLATAFORMA/GRAFICOS_USO_PLATAFORMA-3.jpg" alt="Third slide">
                                                    </div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div id="test7">
                                                        <img data-enlargeable width="100" style="cursor: zoom-in" class="d-block w-100" src="assets/images/infografia/GRAFICOS_USO_PLATAFORMA/GRAFICOS_USO_PLATAFORMA-4.jpg" alt="Third slide">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                <div id="test8">
                                                <img data-enlargeable width="100" style="cursor: zoom-in" class="d-block w-100" src="assets/images/infografia/GRAFICOS_UTILIDAD_PLATAFORMA/GRAFICOS_UTILIDAD_PLATAFORMA_page-0001.jpg" alt="First slide">
                                                </div>
                                                </div>
                                                <div class="carousel-item">
                                                <div id="test9">
                                                <img data-enlargeable width="100" style="cursor: zoom-in" class="d-block w-100" src="assets/images/infografia/GRAFICOS_UTILIDAD_PLATAFORMA/GRAFICOS_UTILIDAD_PLATAFORMA_page-0002.jpg" alt="Second slide">
                                                </div>
                                                </div>
                                                <div class="carousel-item">
                                                <div id="test10">
                                                <img data-enlargeable width="100" style="cursor: zoom-in" class="d-block w-100" src="assets/images/infografia/GRAFICOS_UTILIDAD_PLATAFORMA/GRAFICOS_UTILIDAD_PLATAFORMA_page-0003.jpg" alt="Third slide">
                                                </div>
                                                </div>
                                            </div>
